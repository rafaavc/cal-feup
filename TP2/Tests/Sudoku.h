...
public:
	...
	/**
	 * Checks if a given cell can hold a given number
	 */
    bool isPromising(int i, int j, int n);

    void putAttributes(int i, int j, int n);

    void removeAttributes(int i, int j, int n);
